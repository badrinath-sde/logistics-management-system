...
if (isset($_POST['confirm'])) {
    if (isset($_POST['selectedVehicles'])) {
        ...
        foreach ($selectedVehicles as $vehicleNumber) {
            ...
            $query = "SELECT docket_no FROM vehicle_details WHERE vehicle_number = '$vehicleNumber' AND status = 'Moved' and Out_Loc='$location'";
            ...
            if ($result->num_rows > 0) {
                ...
                $updateVehicleQuery = "UPDATE vehicle_details SET status = 'Received' WHERE vehicle_number = '$vehicleNumber' and status = 'Moved' and Out_Loc='$location'";
        ...
        <div class="container form-container">
            ...
            <div class="responsive-table mt-4">
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <?php
                        $sta = 'Moved'; // Status 'New' for vehicle details
                        if (strtolower($position2) === 'admin') {
                            $query = "SELECT * FROM vehicle_details WHERE status = '$sta'"; // Base query for vehicle details
                        } else {
                            $query = "SELECT * FROM vehicle_details WHERE status = '$sta' and Out_Loc='$location'"; // Base query for vehicle details
                        }
