        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown show">
                    ...
                    <li><a href="Admin_Completed.php" style="color: #2f3192">Completed</a></li>
                ...
                <table class="table table-bordered full-table">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <td><button class='btn btn-info btn-sm view-btn' data-bs-toggle='modal' data-bs-target='#viewModal2{$row['billid']}'>View</button></td>
                        ...
                        <div class='modal fade' id='viewModal{$row['billid']}' tabindex='-1' aria-labelledby='viewModalLabel{$row['billid']}' aria-hidden='true'>
                            <div class='modal-dialog modal-lg'>
                                ...
                                // Modal for PDF view
                                echo "
                        <div class='modal fade' id='viewModal2{$row['billid']}' tabindex='-1' aria-labelledby='viewModalLabel{$row['billid']}' aria-hidden='true'>
                            <div class='modal-dialog modal-lg'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        <h5 class='modal-title' id='viewModalLabel{$row['billid']}'>View PDF for Docket {$row['billid']}</h5>
                                    ...
                                    <div class='modal-body'>
                                        <iframe id='pdfFrame{$row['billid']}' src='BILLIMAGE/{$row['proof_image']}' style='width: 100%; height: 70vh; border: 1px solid #ccc;'></iframe>
                                    </div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Close</button>
                                    </div>
