...
<body>
        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown show">
                    ...
                    <li><a href="Admin_Searchvehicle.php" style="color: #2f3192">Vehicle Search</a></li>
                </ul>
            </li>
    ...
    <section id="content">
            ...
            <div class="responsive-table mt-4">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <?php
                        $sta = 'Received';
                        $staa = 'Cancelled'; // Status 'New' for vehicle details
                        if (strtolower($position2) === 'admin') {
                            $query = "SELECT * FROM vehicle_details WHERE status != '$sta' AND status!='$staa'";
                        } else {
                            $query = "SELECT * FROM vehicle_details WHERE (Out_Loc='$location' OR Ini_Loc='$location') AND status != '$sta' AND status!='$staa'";
                        }
                        ...
                        <td>";
                                ...
                                if (strtolower($position2) === 'admin') {
                                    echo "<td>
                                        ...
                                        <button type='button' class='btn btn-info btn-sm' onclick='confirmform(\"" . $vrid . "\")'>Confirm</button></td>
                                    </td>";
                                }
                                echo "  <td>  <button type='button' class='btn btn-danger btn-sm' onclick='cancelInvoice(\"" . $vehicleNumber . "\")'>Cancel</button></td> </tr>";
        ...
        <form id="cancelForm" action="vehicle_close.php" method="POST">
            <input type="hidden" name="vehicle_number" id="cancelBillidInput" value="">
        </form>
        <form method='POST' action='confirm_vehicle.php' id="confirmform">
            <input type='hidden' name='vrid' value='' id="confirmbillinput">
        </form>
    </section>
    ...
    <script>
        ...
        function confirmform(billid) {
            document.getElementById('confirmbillinput').value = billid;
